...
export interface ContentInternalOrderTableProps<
...
export const ContentInternalOrderTable = React.forwardRef(
  <
    T extends Model,
  ...
  >(
    props: ContentInternalOrderTableProps<T, TContent, TMapper, TContentFilter>,
    ...
    const customizeRenderEmpty = () => (
      <div style={{ textAlign: "center" }}>
        <img src={require("assets/images/empty.svg")} alt="" />
        <div className="text-center gradient-text">
          Đơn hàng của bạn chưa có sản phẩm nào
        </div>
        <button
          className={classNames(
            "mt-3 component_btn-empty btn grow-animate-1 btn-customize direct-sales-order__add-product-btn"
          )}
          onClick={handleClickAddBtn}
        >
          <span className="component_btn-text ">Thêm sản phẩm</span>
        </button>
      </div>
    );
...
ContentInternalOrderTable.defaultProps = {
...
export default ContentInternalOrderTable;
