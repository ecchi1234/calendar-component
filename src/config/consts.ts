...
export const ASSETS_IMAGE: string = PUBLIC_URL ? PUBLIC_URL + '/assets/img' : '/assets/img';
export const ASSETS_SVG: string = PUBLIC_URL ? PUBLIC_URL + '/assets/svg' : '/assets/svg';
