...
function ChatBox(props: ChatBoxProps<ModelFilter>) {
    ...
    const [filter, dispatchFilter] = React.useReducer(updateFilter, {
        discussionId,
        orderType: 'ASC',
        classFilter: ClassFilter
    }, initFilter);
                    ...
                    scrollableTarget="scrollableDiv">
                    {
                        list.map((currentItem, index) => {
                            return <div key={index}
                                ...
                                className={classNames('chat-box__content d-flex mb-4 p-2', (currentItem.creatorId === userInfo?.id ? 'reverse-row' : 'justify-content-start'))}>
                                ...
                                <div className={classNames('msg-container', (currentItem.creatorId === userInfo?.id ? 'msg-container--owner' : 'msg-container--not-owner'))}>
                                ...
                                {currentItem.isOwner && <div className="msg-icon">
                                    {currentItem.isPopup ?
                                        ...
                                        <div>
                                            <i className="error-text tio-remove_from_trash" onClick={popupConfirm(currentItem)} />
                                        </div>
